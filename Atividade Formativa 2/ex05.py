#Escreva um programa que solicite ao usuário o salário atual e o tempo de serviço em anos. 
#Se o tempo de serviço for superior a 5 anos, concede um bônus de 5% sobre o salário. 
#Caso contrário, não conceda bônus.
